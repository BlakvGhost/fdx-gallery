                            ...
                            <form action="/user/app/login" method="post">
                                ...
                                <div class="form-group my-2">
                                    <div class="input-group">
                                        <input type="password" required class="form-control bg-light" name="password"
                                ...
                                <div class="my-2 d-flex justify-content-between">
                                    ...
                                    <router-link :to="{name: 'register'}" class="btn btn-link text-white">Create Account</router-link>
                                </div>
                                <div class="my-3 text-center">
