            ...
            <div class="p-2 w-50 mx-auto">
              <div class="fw-bold m-0 border-0 text-center">
                <a
                  ...
                  class="btn-load text-decoration-none text-white col-8 col"
                  >GalleryApp</a
                >
              </div>
            </div>
            ...
            <div class="my-2">
              <form action="/user/app/login" method="post">
                ...
                <div class="form-group my-2">
                  <div class="input-group">
                    ...
                    <div class="input-group-append">
                      <button type="button" class="btn btn-danger password-visible">
                ...
                <div class="my-2 d-flex justify-content-between">
                  <a href="javascript:void(0)" class="btn btn-link text-white"
                    >Forgot your Password ?</a
                  >
                  <router-link :to="{ name: 'register' }" class="btn btn-link text-white"
